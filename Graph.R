...
nReadWritePerf$V6<-nReadWritePerf$V3/nReadWritePerf$V4
...
nWrites$V6<-nWrites$V3/nWrites$V4

nReadWrite <- read.csv('./experiments/params-results.csv', header=FALSE, colClasses=c('numeric', rep('numeric', 3), 'numeric'))
...
plot(nWrites$V5 ~ nWrites$V6, data=nWrites, type="b", col="red", ylab="Successfull transaction rate %", xlab="Ratio of Read/Writes", main="Chaning the ratio of Read/Writes")
